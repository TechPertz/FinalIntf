...
def get_relevant_context(query: str, faiss_path: str, db_path: str, top_k: int = 5) -> dict:
    ...
    try:
        ...
        if entities:  # Only do graph retrieval if entities found
        ...
        # Combine and deduplicate results based on text
        seen_texts = set()
        combined_results = []
        ...
        return {
            "query": query,
            "results": combined_results[:top_k]  # Return only top_k results after deduplication
        }
