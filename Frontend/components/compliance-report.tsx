            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                {report.individual_results.map((result, index) => (
                  <div 
                    key={index}
                    className="bg-white/50 dark:bg-gray-900/50 p-6 rounded-lg border border-indigo-100 dark:border-indigo-900"
                  >
                    <div className="mb-4">
                      <h5 className="text-md font-semibold mb-2">Document Section {index + 1}</h5>
