      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
        ...
        >
          {showReport ? (
            ...
            <Card className="h-full flex items-center justify-center p-10 bg-white/30 dark:bg-gray-800/30 backdrop-blur-sm rounded-xl border border-indigo-100 dark:border-indigo-900">
